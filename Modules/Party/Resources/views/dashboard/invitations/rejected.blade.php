...
@section('title', __('apps::dashboard._layout.aside.rejected_invitations'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('apps::dashboard._layout.aside.rejected_invitations')}}</a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">
                                {{__('apps::dashboard._layout.aside.rejected_invitations')}}
                            </span>
                        </div>
                    </div>
  ...
  <script>
   function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('dashboard.invitations.datatable')) }}?status=3",
              type  : "GET",
              data  : {
                  req : data,
              },
