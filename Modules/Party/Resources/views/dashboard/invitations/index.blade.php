...
@section('title', __('party::dashboard.invitations.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('party::dashboard.invitations.routes.index')}}</a>
                </li>
            </ul>
        </div>
  ...
  <script>
   function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('dashboard.invitations.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
